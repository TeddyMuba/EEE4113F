...
import { AccordionCard, ListPair, Nav } from "../../components";
import { FaDownload, FaExclamationTriangle, FaImage } from "react-icons/fa";
        ...
        <SimpleGrid columns={2} spacing={4} alignItems="flex-start">
          ...
          <VStack>
            ...
            >
              ...
              {/* <ListPair
              value={`${event?.power_status.battery_level}%`}
              label="Battery Level"
            /> */}
            </VStack>
